...
try {
    ...
    $support_email = $db->query("SELECT setting_value FROM settings WHERE setting_key = 'support_email'")->fetchColumn() ?: 'seguran̤a@aksanti.ao';
} catch (Exception $e) {
    $site_name = 'KALIYE';
    $support_email = 'seguran̤a@aksanti.ao';
}
?>
<!DOCTYPE html>
<html lang="pt">

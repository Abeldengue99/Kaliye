...
<head>
    ...
    <style>
        /* CSS adicional para deixar o card menor e mais elegante */
        .login-card-compact {
...
<body class="auth-bg" style="min-height: 100vh; overflow-x: hidden; display: flex; align-items: center; justify-content: center; padding: 0.5rem;">
    ...
    <div class="login-card glass glow-card login-card-compact" data-aos="zoom-in" style="position: relative; z-index: 10;">

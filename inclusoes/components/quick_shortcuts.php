...
<div class="quick-shortcuts">
    ...
    <?php endif; ?>
        ...
        <a href="<?php echo $base_url; ?>paginas/explorar/my_projects.php" class="shortcut-card glass" onclick="return enforceKYC(event)"> <?php // Corrigido de profile#my-projects para página dedicada ?>
    ...
    <a href="<?php echo $base_url; ?>paginas/explorar/explore_mentors.php" class="shortcut-card glass" onclick="return enforceKYC(event)">
        ...
        <?php if ($_is_mentor || $_is_admin || $_role === 'investor'): ?>
    <a href="<?php echo $base_url; ?>paginas/explorar/explore_students.php" class="shortcut-card glass" onclick="return enforceKYC(event)"> <?php // Corrigido de form_students para explore_students e restringido a mentores/investidores ?>
        <div class="icon-box" style="background: rgba(16,185,129,0.1); color: #10b981;">
    ...
    <?php endif; ?>
        ...
        <a href="<?php echo $base_url; ?>paginas/mentoria/mentorship.php" class="shortcut-card glass" onclick="return enforceKYC(event)"> <?php // Atalho rápido para a central de progresso em cascata ?>
        <div class="icon-box" style="background: rgba(59,130,246,0.1); color: #3b82f6;">
        ...
        <?php if (!$_is_student): ?>
    <a href="<?php echo $base_url; ?>paginas/social/profile.php" class="shortcut-card glass" onclick="return enforceKYC(event)"> <?php // Corrigido links morto e oculto para estudantes ?>
        <div class="icon-box" style="background: rgba(247,148,29,0.1); color: #f7941d;">
